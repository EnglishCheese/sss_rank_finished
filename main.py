...
ship2 = Player2(img_hero2, 600, win_height - 80, 80, 100, 10)
    ...
    if show_game:
        ...
        if not finish:
            ...
            for c in collides:
                ...
                monsters.add(monster)
            collides2 = sprite.groupcollide(monsters, bullets2, True,
                                           True)
            for c in collides2:
                score += 1
                monster = Enemy(img_enemy, randint(50, win_width-80),
